...
var requestPromise_1 = require("./helper/requestPromise");
var github_1 = require("../config/github");
exports.authenticate = function (callback, errorHandler) { return __awaiter(_this, void 0, void 0, function () {
    var options;
    return __generator(this, function (_a) {
        options = {
            method: 'GET',
            uri: "https://github.com/login/oauth/authorize?client_id=" + github_1.CONFIG.client_id,
            json: true
        };
        requestPromise_1.requestPromise(options, callback, errorHandler);
        return [2 /*return*/];
    });
}); };
